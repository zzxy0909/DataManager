...
//		string dbpath = "jar:file://" + Application.dataPath + "!/assets/" + dbfilename;
		log += " asset path is: " + dbpath;
	...
	void OnGUI()
	{
		if( db == null )
		{
			...
			if ( GUI.Button(new Rect (170,10,150,70), "Run SQLite Test \nfor streamingAssets db\nwhich moved to \npersistentDataPath") ) 
			{
				...
				string dbpath = "file://" + Application.streamingAssetsPath + "/" + dbfilename; log += "asset path is: " + dbpath;
				string dbpath2 = "file://" + Application.streamingAssetsPath + "/" + dbfilename; log += "asset path is: " + dbpath2;
				WWW www = new WWW(dbpath);
				Download(www);
				bytes = www.bytes;
...
#elif UNITY_ANDROID
				string dbpath = Application.streamingAssetsPath + "/" + dbfilename;	            log += "asset path is: " + dbpath;
				string dbpath2 = Application.persistentDataPath + "/" + dbfilename;	            log += "asset path is: " + dbpath;
				WWW www = new WWW(dbpath);
				Download(www);
				bytes = www.bytes;
#endif
